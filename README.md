...
##   **Основы компьютерных сетей и веба**
  ...
  *   **Сети:** Как работает DNS, структура IP-адресов, порты, сокеты.

  *   **Модель OSI:** Четкое понимание хотя бы транспортного (L4) и прикладного (L7) уровней (особенно важно для проксирования и балансировки трафика).
